...
async def main_menu_buy(message):
    ...
    with open("files/photo_2024-11-24_16-36-39.jpg","rb") as img2:
        await message.answer_photo(img2,"Название: Product1 | Описание:описание 2 |Цена: 200")
    with open("files/photo_2024-11-24_16-37-20.jpg", "rb") as img3:
        await message.answer_photo(img3, "Название: Product1 | Описание:описание 3 |Цена: 300")
